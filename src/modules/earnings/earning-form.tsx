...
export function EarningForm({
	...
	serverErrors?: FieldErrors<typeof earningForm>;
	earning: Earning;
	...
	return (
		...
		>
			...
			<Label className="block w-full">
				...
				<Input
					{...earningForm.inputProps.description}
			...
			<Label className="block w-full">
				...
				<Select
					{...earningForm.inputProps.categoryId}
					options={categories}
					defaultValue={earning.categoryId ?? undefined}
				/>
			</Label>
			<Label className="block w-full">
				...
				<Input
					...
					defaultValue={new Date(earning.date)
						.toISOString()
